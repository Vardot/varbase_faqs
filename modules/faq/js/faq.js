(function ($, Drupal, drupalSettings) {
  ...
  Drupal.behaviors.initFaqModule = {
    attach: function (context, settings) {
      ...
      $('div.faq-dt-hide-answer:not(.faq-processed)', context).addClass('faq-processed').on('click', function () {
        if (faq_hide_qa_accordion) {
      ...
      $('div.faq-qa-header .faq-header:not(.faq-processed)', context).addClass('faq-processed').on('click', function () {
        if (faq_category_hide_qa_accordion) {
      ...
      if (!faq_hide_qa_accordion && !faq_category_hide_qa_accordion) {
        ...
        $('#faq-expand-all a.faq-collapse-all-link:not(.faq-processed)', context).addClass('faq-processed').on('click', function () {
          $(this).hide();
        ...
        $('#faq-expand-all a.faq-expand-all-link:not(.faq-processed)', context).addClass('faq-processed').on('click', function () {
          $(this).hide();
      ...
      $('input[name=faq_display]:not(.faq-processed)', context).addClass('faq-processed').on('click', faq_display_handler);
      $('input[name=faq_qa_mark]:not(.faq-processed)', context).addClass('faq-processed').on('click', qa_mark_handler);
      $('input[name=faq_use_teaser]:not(.faq-processed)', context).addClass('faq-processed').on('click', teaser_handler);
      $('input[name=faq_category_display]:not(.faq-processed)', context).addClass('faq-processed').on('click', categories_handler);
      $('input[name=faq_hide_child_terms]:not(.faq-processed)', context).addClass('faq-processed').on('click', child_term_handler);
    }
  };
