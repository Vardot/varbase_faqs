...
class QuestionsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['faq_questions_misc'] = [
      '#type' => 'details',
      '#title' => $this->t('Miscellaneous layout settings'),
      '#open' => TRUE,
    ];

    $form['faq_questions_misc']['faq_question_listing'] = [
      '#type' => 'select',
      '#options' => [
    ...
    $form['faq_questions_misc']['faq_qa_mark'] = [
      '#type' => 'checkbox',
    ...
    $form['faq_questions_misc']['faq_question_label'] = [
      '#type' => 'textfield',
    ...
    $form['faq_questions_misc']['faq_answer_label'] = [
      '#type' => 'textfield',
    ...
    $form['faq_questions_misc']['faq_question_length'] = [
      '#type' => 'radios',
      ...
      '#description' => $this->t("The length of question text to display on the FAQ page.  The short question will always be displayed in the FAQ blocks."),
      '#default_value' => $faq_settings->get('question_length'),
    ];

    $form['faq_questions_misc']['faq_question_long_form'] = [
      '#type' => 'checkbox',
      '#title' => $this->t('Allow long question text to be configured'),
      '#default_value' => $faq_settings->get('question_long_form'),
    ];

    $form['faq_questions_misc']['faq_hide_qa_accordion'] = [
      '#type' => 'checkbox',
    ...
    $form['faq_questions_misc']['faq_show_expand_all'] = [
      '#type' => 'checkbox',
    ...
    // );.
    $form['faq_questions_misc']['faq_back_to_top'] = [
      '#type' => 'textfield',
    ...
    $form['faq_questions_misc']['faq_disable_node_links'] = [
      '#type' => 'checkbox',
    ...
    $form['faq_questions_misc']['faq_default_sorting'] = [
      '#type' => 'select',
      ...
      '#description' => $this->t("This controls the default ordering behaviour for new FAQ nodes which haven't been assigned a position."),
